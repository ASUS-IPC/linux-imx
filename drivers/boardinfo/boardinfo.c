...
static int gpio_hwid_probe(struct platform_device *pdev)
{
	...
	if (strcmp(boardinfo, "PE100A") == 0 || strcmp(boardinfo, "IM-A") == 0) {
...
/* PE100A return 0, PV100A return 1, IM-A return 2, BLIZZARD return 3 */
int boardinfo_show(void) {
	if (strcmp(boardinfo, "PE100A") == 0)
		...
		return 2;
	else if (strcmp(boardinfo, "BLIZZARD") == 0)
		return 3;
	else
		return -1;
}
